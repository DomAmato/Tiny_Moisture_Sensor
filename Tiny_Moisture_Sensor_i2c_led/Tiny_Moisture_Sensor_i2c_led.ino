...
/************************************
 * 
 * WARNING!! using the reset pin on the attiny will
 * essentially prevent it from being programmable
 * it is possible using high voltage to change the fuses
 * but it is a lot of work and kinda a pain
 * 
 * ONLY UPLOAD THIS VERSION IF YOU ARE
 * SURE YOU WONT BE MAKING ANY CHANGES
 * 
 ***************************************/
